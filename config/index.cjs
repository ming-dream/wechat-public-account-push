...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx5baeba37d603c69d',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '759ccb9add986e767fc755e0b0daaa73',
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'Lgrma65eOYqF9LZcNNXRmK-qs_VpLzpV-H43YIw3xo4',
      // 所在省份
      province: '上海',
      // 所在城市
      city: '上海',
      ...
      openUrl: 'https://weathernew.pae.baidu.com/weathernew/pc?query=%E4%B8%8A%E6%B5%B7%E5%A4%A9%E6%B0%94&srcid=4982',
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '生日 ', name: '倩倩', year: '1999', date: '12-01',
        },
        {
          type: '生日 ', name: '宇飞', year: '1997', date: '09-05',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '节日', name: '羊毛 的驱虫日', year: '2022', date: '10-24',
        }
      ],
